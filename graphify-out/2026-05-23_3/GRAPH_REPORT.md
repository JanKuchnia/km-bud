...
## Corpus Check
- 193 files · ~3,130,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4354 nodes · 4401 edges · 385 communities (376 shown, 9 thin omitted)
...
## Communities (385 total, 9 thin omitted)
...
- **Why does `main()` connect `Test Runner` to `Security and Coverage Scans`?**
